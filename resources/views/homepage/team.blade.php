       ...
       <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
        <div class="team-item">
            <div class="d-flex">
                ...
                <img class="img-fluid rounded w-75" src="{{ asset('img/Hilmi.jpg') }}" alt="" style="height: 300px; object-fit: cover;">
            </div>
            <div class="px-4 py-3">
    ...
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="team-item">
            <div class="d-flex">
                ...
                <img class="img-fluid rounded w-75" src="{{ asset('img/ripa.jpg') }}" alt="" style="height: 300px; object-fit: cover;">
            </div>
            <div class="px-4 py-3">
    ...
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
        <div class="team-item">
            <div class="d-flex">
                ...
                <img class="img-fluid rounded w-75" src="{{ asset('img/yasmin.jpg') }}" alt="" style="height: 300px; object-fit: cover;">
            </div>
            <div class="px-4 py-3">
    ...
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.9s">
        <div class="team-item">
            <div class="d-flex">
                ...
                <img class="img-fluid rounded w-75" src="{{ asset('img/juni.jpg') }}" alt="" style="height: 300px; object-fit: cover;">
            </div>
            <div class="px-4 py-3">
